...
from torchvision.models.resnet import BasicBlock, Bottleneck, conv1x1, model_urls, ResNet
...
# def colorization_resnet101(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
...
# class ColorizationResNet101(nn.Module):
#     def __init__(self, pretrained: bool = False, progress: bool = True, **kwargs: Any):
#         super().__init__()
#         self.resnet = colorization_resnet101(pretrained, progress, **kwargs)
#
#     @auto_fp16()
#     def forward(self, x):
#         out = self.resnet(x)
...
a = ColorizationResNet(num_layers=101, pretrained=None)